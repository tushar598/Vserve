...
export default function AttendanceLogs({
  ...
  function formatTo12Hour(timeStr?: string) {
    ...
    // Split by colon to handle various time formats (HH:mm or HH:mm:ss)
    ...
    // Create a dummy date to use built-in formatting
    const date = new Date();
      ...
      <CardContent className="p-0 overflow-x-auto">
        <div className="w-full overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 text-sm sm:text-base">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-3 sm:px-4 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase">Name</th>
                <th className="px-3 sm:px-4 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase"><Phone className="inline w-4 h-4 mr-1" /> Phone</th>
                <th className="px-3 sm:px-4 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase"><Calendar className="inline w-4 h-4 mr-1" /> Date</th>
                <th className="px-3 sm:px-4 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase">Status</th>
                <th className="px-3 sm:px-4 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase">Check-in</th>
                <th className="px-3 sm:px-4 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase">Check-Out</th>
                <th className="px-3 sm:px-4 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase">Location</th>
                <th className="px-3 sm:px-4 py-2 text-left text-xs sm:text-sm font-medium text-gray-500 uppercase">Department</th>
              </tr>
            </thead>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredRows.map((row, index) => (
                <tr
                  ...
                  className="hover:bg-gray-50 transition-colors cursor-pointer"
                >
                  <td className="px-3 sm:px-4 py-2 text-gray-700">{row.name}</td>
                  <td className="px-3 sm:px-4 py-2 text-gray-700">{row.phone}</td>
                  <td className="px-3 sm:px-4 py-2 text-gray-700">{extractDate(row.date)}</td>
                  ...
                  <td className="px-3 sm:px-4 py-2">
                    {(() => {
                      ...
                      const nineAM = 9 * 60;
                      const tenAM = 10 * 60;
                      let status = (checkInMinutes < nineAM || checkInMinutes > tenAM) ? "Late" : "On-time";
                  ...
                  <td className="px-3 sm:px-4 py-2 text-gray-700">{row.location || "—"}</td>
                  <td className="px-3 sm:px-4 py-2 text-gray-700">{row.department || "—"}</td>
                </tr>
              ))}
            </tbody>
          </table>
